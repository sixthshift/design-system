...
describe("CalendarView", () => {
  describe("rendering", () => {
    it("renders a grid", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
  ...
  describe("single mode", () => {
    ...
    it("calls onSelect with the clicked Temporal.PlainDate", async () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("marks the selected date with the selected class", () => {
      render(<CalendarView mode="single" value={FEB_2024.with({ day: 15 })} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
      const day15 = getDay(document.body, FEB_2024.with({ day: 15 }));
    ...
    it("calls onSelect with undefined when the selected date is clicked again (toggle off)", async () => {
      ...
      render(<CalendarView mode="single" value={selected} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("is a controlled component: selecting a new date does not change the value prop rendering until re-rendered", async () => {
      const user = userEvent.setup();
      const handleSelect = vi.fn();
      const { rerender } = render(<CalendarView mode="single" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);

      const day10 = getDay(document.body, FEB_2024.with({ day: 10 }));
      await user.click(day10);
      expect(day10).not.toHaveClass("bg-bg-brand");

      rerender(<CalendarView mode="single" value={FEB_2024.with({ day: 10 })} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
  ...
  describe("multiple mode", () => {
    it("renders with an empty selection", () => {
      render(<CalendarView mode="multiple" value={[]} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
      const day15 = getDay(document.body, FEB_2024.with({ day: 15 }));
      expect(day15).not.toHaveClass("bg-bg-brand");
    });
    ...
    it("calls onSelect with the date appended when an unselected date is clicked", async () => {
      ...
      render(<CalendarView mode="multiple" value={[existing]} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("calls onSelect with the date removed when a selected date is clicked again", async () => {
      ...
      render(<CalendarView mode="multiple" value={dates} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("marks all selected dates with the selected class", () => {
      ...
      render(<CalendarView mode="multiple" value={dates} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("does not call onSelect to add beyond the max limit", async () => {
      ...
      render(<CalendarView mode="multiple" value={dates} onSelect={handleSelect} max={2} month={FEB_2024} onMonthChange={() => {}} />);
  ...
  describe("range mode", () => {
    it("renders with no selection", () => {
      render(<CalendarView mode="range" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
      const day15 = getDay(document.body, FEB_2024.with({ day: 15 }));
      expect(day15).not.toHaveClass("bg-bg-brand");
    });
    ...
    it("sets 'from' on the first click", async () => {
      const user = userEvent.setup();
      const handleSelect = vi.fn();
      render(<CalendarView mode="range" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("sets 'to' on the second click when the date is after 'from'", async () => {
      ...
      render(<CalendarView mode="range" value={{ from, to: undefined }} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("starts a new range when clicking after both 'from' and 'to' are set", async () => {
      ...
      render(<CalendarView mode="range" value={{ from, to }} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("marks the start of a range with the selected class", () => {
      const from = FEB_2024.with({ day: 10 });
      const to = FEB_2024.with({ day: 20 });
      render(<CalendarView mode="range" value={{ from, to }} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("marks a single-day range (from === to) with the selected class", () => {
      ...
      render(<CalendarView mode="range" value={{ from: day, to: day }} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
  ...
  describe("navigation", () => {
    it("calls onMonthChange with the previous month when clicking 'Previous month'", async () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={handleMonthChange} />);
    ...
    it("navigates from December into January of the next year", async () => {
      const user = userEvent.setup();
      const handleMonthChange = vi.fn();
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={DEC_2024} onMonthChange={handleMonthChange} />);
    ...
    it("navigates from January into December of the previous year", async () => {
      const user = userEvent.setup();
      const handleMonthChange = vi.fn();
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={JAN_2025} onMonthChange={handleMonthChange} />);
    ...
    it("re-renders the grid for the new month when the month prop changes", () => {
      const { rerender } = render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
      expect(screen.getByText("February 2024")).toBeInTheDocument();

      rerender(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={DEC_2024} onMonthChange={() => {}} />);
  ...
  describe("disabled dates", () => {
    it("disables a single disabled date", () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} disabled={disabledDate} />);
    ...
    it("disables an array of dates", () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} disabled={disabledDates} />);
    ...
    it("disables dates matching a predicate function", () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} disabled={isWeekend} />);
    ...
    it("does not call onSelect when a disabled date is clicked", async () => {
      ...
      const handleSelect = vi.fn();
      const disabledDate = FEB_2024.with({ day: 15 });
      render(<CalendarView mode="single" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} disabled={disabledDate} />);
  ...
  describe("min/max dates", () => {
    it("disables dates before minDate", () => {
      render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} minDate={FEB_2024.with({ day: 10 })} />
      );
      expect(getDay(document.body, FEB_2024.with({ day: 5 }))).toBeDisabled();
      expect(getDay(document.body, FEB_2024.with({ day: 10 }))).not.toBeDisabled();
      expect(getDay(document.body, FEB_2024.with({ day: 15 }))).not.toBeDisabled();
    ...
    it("disables dates after maxDate", () => {
      render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} maxDate={FEB_2024.with({ day: 20 })} />
      );
      expect(getDay(document.body, FEB_2024.with({ day: 25 }))).toBeDisabled();
      expect(getDay(document.body, FEB_2024.with({ day: 20 }))).not.toBeDisabled();
      expect(getDay(document.body, FEB_2024.with({ day: 15 }))).not.toBeDisabled();
  ...
  describe("presets", () => {
    it("renders a preset button for each preset (single mode)", () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
    ...
    it("calls onSelect with the preset value when a single-mode preset is clicked", async () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
    ...
    it("calls onSelect with the preset range when a range-mode preset is clicked", async () => {
      ...
      render(<CalendarView mode="range" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
    ...
    it("calls onSelect with the preset array when a multiple-mode preset is clicked", async () => {
      ...
      render(<CalendarView mode="multiple" value={[]} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
    ...
    it("highlights the active preset that matches the current value", () => {
      ...
      render(<CalendarView mode="single" value={tomorrow} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
    ...
    it("does not highlight any preset when the value doesn't match", () => {
      ...
      render(<CalendarView mode="single" value={FEB_2024.with({ day: 3 })} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} presets={presets} />);
  ...
  describe("footer", () => {
    ...
    it("calls onApply when Apply is clicked", async () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} showFooter onApply={handleApply} />);
    ...
    it("calls onCancel when Cancel is clicked", async () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} showFooter onCancel={handleCancel} />);
    ...
    it("renders the Today button when showFooter and showToday are true and mode is not range", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} showFooter showToday />);
      expect(screen.getByRole("button", { name: "Today" })).toBeInTheDocument();
    });

    it("does not render the Today button when showToday is false", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} showFooter showToday={false} />);
      expect(screen.queryByRole("button", { name: "Today" })).not.toBeInTheDocument();
    });

    it("does not render the Today button in range mode even when showToday is true", () => {
      render(<CalendarView mode="range" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} showFooter showToday />);
      expect(screen.queryByRole("button", { name: "Today" })).not.toBeInTheDocument();
    });
    ...
    it("selects the fixed today's date and navigates to today's month when Today is clicked (single mode)", async () => {
      ...
      const handleSelect = vi.fn();
      const handleMonthChange = vi.fn();
      render(<CalendarView mode="single" value={undefined} onSelect={handleSelect} month={FEB_2024} onMonthChange={handleMonthChange} showFooter showToday />);
    ...
    it("appends today's date in multiple mode when Today is clicked", async () => {
      ...
      const handleSelect = vi.fn();
      const existing = [FEB_2024.with({ day: 5 })];
      render(<CalendarView mode="multiple" value={existing} onSelect={handleSelect} month={FEB_2024} onMonthChange={() => {}} showFooter showToday />);
    ...
    it("does not duplicate today's date in multiple mode if already selected", async () => {
      ...
      render(<CalendarView mode="multiple" value={existing} onSelect={handleSelect} month={FEB_2024} onMonthChange={handleMonthChange} showFooter showToday />);
  ...
  describe("today highlighting", () => {
    ...
    it("omits the today ring class when today is selected (selection style takes over)", () => {
      render(<CalendarView mode="single" value={FIXED_TODAY} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
      const todayButton = getDay(document.body, FIXED_TODAY);
    ...
    it("does not mark any day as today when the displayed month doesn't include today", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={DEC_2024} onMonthChange={() => {}} />);
  ...
  describe("className merging", () => {
    it("merges a custom className onto the root element", () => {
      const { container } = render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} className="custom-calendar" />
      );
  ...
  describe("weekStartsOn day labels", () => {
    it.each([0, 1, 2, 3, 4, 5, 6] as const)("rotates the day-of-week header to start on day %i", (weekStartsOn) => {
      ...
      const { container } = render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} weekStartsOn={weekStartsOn} />
      );
  ...
  describe("weekStartsOn grid alignment", () => {
    it("starts the grid on Sunday before the 1st when weekStartsOn=0 (Feb 2024 starts on Thursday)", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} weekStartsOn={0} />);
    ...
    it("starts the grid on Monday before the 1st when weekStartsOn=1 (Feb 2024 starts on Thursday)", () => {
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} weekStartsOn={1} />);
      expect(getDay(document.body, FEB_2024.with({ day: 1 }))).toBeInTheDocument();
    });

    it("renders the same number of leading blank cells consistent with a 6-week (42-day) grid", () => {
      const { container: gridSunday } = render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} weekStartsOn={0} />
      );
  ...
  describe("edge cases", () => {
    ...
    it("does not render Feb 29 on a non-leap year", () => {
      ...
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={feb2025} onMonthChange={() => {}} />);
    ...
    it("handles a range value with only 'from' set", () => {
      render(
        <CalendarView mode="range" value={{ from: FEB_2024.with({ day: 10 }), to: undefined }} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />
      );
    ...
    it("handles a range value with only 'to' set", () => {
      render(
        <CalendarView mode="range" value={{ from: undefined, to: FEB_2024.with({ day: 10 }) }} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />
      );
      const day = getDay(document.body, FEB_2024.with({ day: 10 }));
      expect(day).toHaveClass("bg-bg-brand");
    });
  ...
  describe("grid keyboard navigation", () => {
    const renderCalendar = (onMonthChange = () => {}) =>
      render(<CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={onMonthChange} weekStartsOn={0} />);
    ...
    it("puts aria-selected on the gridcell, not on the day button", () => {
      ...
      const { container } = render(<CalendarView mode="single" value={selected} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} />);
    ...
    it("does not put the tab stop on a disabled day", () => {
      ...
      const { container } = render(
        <CalendarView mode="single" value={undefined} onSelect={() => {}} month={FEB_2024} onMonthChange={() => {}} disabled={FIXED_TODAY} />
      );
      expect(getDay(container, FIXED_TODAY)).toHaveAttribute("tabindex", "-1");
      const tabbable = Array.from(container.querySelectorAll("[data-date]")).filter((el) => el.getAttribute("tabindex") === "0");
      expect(tabbable).toHaveLength(1);
