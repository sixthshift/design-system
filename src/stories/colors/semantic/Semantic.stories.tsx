...
/**
 * The semantic colour tokens, as swatches — what each meaning looks like in
 * each mode, and how it moves under interaction.
 *
 * This is the *visual* view of the layer. The exhaustive, textual list of every
 * CSS variable the system declares — palette, semantic, layering, motion,
